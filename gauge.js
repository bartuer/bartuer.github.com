    ...
    if (!document.getElementById(tmp)) {
      try {
        if (document.all && document.namespaces && !window.opera && (!document.documentMode || document.documentMode < 9)) {
          ...
          self = document.createElement(['<var style="zoom:1;display:' + dpl + ';width:' + width + 'px;height:' + height + 'px;padding:0px;margin:0px;">'].join(''));
  ...
  modify: function (self, options) {
    ...
    if (self) {
      var i, q, g, c, n, a, z, l, t = 0,
        ...
        r = parseInt(v ? self.width / 2 : self.height / 3, 10),
      ...
      try {
        ...
        if (document.all && document.namespaces && !window.opera && self.tagName.toUpperCase() === "VAR" && (!document.documentMode || document.documentMode < 9)) {
          var head, foot, fyll, flex, shadb, shadd, scalb = '',
            scald = '';
          j = 'm 0,0 l 0,' + parseInt((r - q) * 100, 10) + ' qy ' + parseInt(q * 100, 10) + ',' + parseInt(r * 100, 10) + ' l ' + parseInt((w - q) * 100, 10) + ',' + parseInt(r * 100, 10) + ' qx ' + parseInt(w * 100, 10) + ',' + parseInt((r - q) * 100, 10) + ' l ' + parseInt(w * 100, 10) + ',0 x e';
          ...
          if (v) {
            j = 'm ' + parseInt(r * 100, 10) + ',0 l ' + parseInt(q * 100, 10) + ',0 qx 0,' + parseInt(q * 100, 10) + ' l 0,' + parseInt((h - q) * 100, 10) + ' qy ' + parseInt(q * 100, 10) + ',' + parseInt(h * 100, 10) + ' l ' + parseInt(r * 100, 10) + ',' + parseInt(h * 100, 10) + ' x e';
          ...
          if (self.vl && !self.bu) {
            ...
            if (v) {
              flex += '<v:fill color="' + (self.lv && Math.abs(self.vl[0]) <= 0 ? self.cc : pick(0)) + '" on="t" /></v:shape>';
            } else {
              flex += '<v:fill color="' + a + '" color2="' + z + '" type="gradient" colors="' + n + '" method="linear" angle="' + (v ? 0 : 270) + '" on="t" /></v:shape>';
            }
          } else {
            c = self.bu ? pick(0) : self.cc;
          ...
          if (!self.ns) {
            ...
            if (v) {
              for (i = 0; i < k; i += 1) {
                a += ' m 100,' + parseInt((h * 100) - (b * 100) - (i * (b * 100)) + 100, 10) + ' l ' + parseInt((w * 100) - 100, 10) + ',' + parseInt((h * 100) - (b * 100) - (i * (b * 100)) + 100, 10) + ' e';
                z += ' m 100,' + parseInt((h * 100) - (b * 100) - (i * (b * 100)), 10) + ' l ' + parseInt((w * 100) - 100, 10) + ',' + parseInt((h * 100) - (b * 100) - (i * (b * 100)), 10) + ' e';
              }
            }
            else {
              for (i = 0; i < k; i += 1) {
                a += ' m ' + parseInt((b * 100) + (i * (b * 100)) + 100, 10) + ',100 l ' + parseInt((b * 100) + (i * (b * 100)) + 100, 10) + ',' + parseInt((h * 100) - 100, 10) + ' e';
                z += ' m ' + parseInt((b * 100) + (i * (b * 100)), 10) + ',100 l ' + parseInt((b * 100) + (i * (b * 100)), 10) + ',' + parseInt((h * 100) - 100, 10) + ' e';
              }
            }
          ...
          var paint = function (j) {
            ...
            if (self.bu) {
              a = face(pick(0), pick(1), j / 10, true);
              ...
              if (v) {
                self.ctx.fillStyle = "rgba(" + (self.lv && Math.abs(self.vl[0]) <= 0 ? self.dc : hex2rgb(pick(0))) + "," + (window.opera ? 1.0 : self.op) + ")";
                fill(0, h, w, w);
              }
            } else {
              self.ctx.fillStyle = "rgba(" + self.dc + "," + (window.opera ? 1.0 : self.op) + ")";
